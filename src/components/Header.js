...
const Header = () => {
  return (
    <>
    <header className="header-top-strip navbar-container py-3">
        ...
        <div className="row">
          ...
          <div className="col-6">
            <p className="text-end text-white mb-0">
              Hotline: <a className="text-white" href="tel:+91 8630352849">+91 8630352849</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <header className="header-upper py-3">
      <div className="container-xxl">
        <div className="row align-items-center">
          <div className="col-2">
            <h3>
            <Link className="text-white">VIP</Link>
            </h3>
          </div>
          <div className="col-5">
            ...
            <div className="header-upper-links d-flex align-items-center justify-content-between">
              ...
              <div>
                ...
                <div className="d-flex flex-column gap-10">
                  <span clssname="badge badge-working">0</span>
